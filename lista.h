...
typedef int (*comparador_lista)(void*, void*);
 ...
 */
lista_t* lista_crear(comparador_lista,lista_liberar_elemento);
...
void* lista_buscar(lista_t* lista,void* elemento,size_t* posicion);
